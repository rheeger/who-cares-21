      ...
      <div>
        <FullscreenWrapper>
          ...
          >
            ...
            <a
              href="https://www.airbnb.com/wishlists/872572412/join?invite_code=TSETAEBA&inviter_id=24329714&s=67&unique_share_id=763fe7bb-e1cc-46a2-98fe-8485c1654c2f"
              target="new"
            >
              <Button
            ...
            <a
              href="https://www.vrbo.com/tripboard/i/3e6f14ad-6e53-41b2-b51d-eef1b89ea92d?client=web&oc=xti2k_kt4Vy6w19ZrDTPF"
              target="new"
            >
              <Button
                className="ui button blue-button"
            ...
            <TinyHeader>
              ...
              Lenox, MA 01240
              <br />
              Big, clean, beautiful room with good access to both Pittsfield and
              Lenox.
              <br />
              Room Block: Friedman-Heeger
            </TinyHeader>
            <a
              href="https://www.marriott.com/hotels/travel/gbrcy-courtyard-lenox-berkshires/"
              target="new"
            >
              <Button
                className="ui button blue-button"
            ...
            <TinyHeader>
              ...
              <br /> Walking distance to Wedding Party.
              <br />
              Room Block: Friedman-Heeger
            </TinyHeader>
            <a
              href="https://www.choicehotels.com/massachusetts/lee/ascend-hotels/ma177/rates?checkInDate=2021-06-25&checkOutDate=2021-06-27"
              target="new"
            >
              <Button
                className="ui button blue-button"
